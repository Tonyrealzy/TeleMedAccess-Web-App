  ...
  return (
    <div className="TermsandCondition">
      ...
      <section>
        <h2>Acceptance</h2>
        <p>
          Welcome to TeleMedAccess (TEMA). By accessing or using our platform,
          you agree to comply with and be bound by the following Terms and
          Conditions. These terms govern your use of our services, including our
          website, mobile applications, and other services. You must read the
          following terms and conditions carefully. This Terms of Use Agreement
          (“Agreement”) is a legal agreement between you and the developers of
          the TEMA app (Arinze, Bernard, and Isaac). It states the terms and
          conditions under which you may access and use the App and all written
          and other materials displayed or made available through the App.
          Please read these terms carefully. If you do not agree with any part
          of these terms, you must not use our services.
        </p>
        <br />
        <p>
          Note that the Owner may revise this Agreement at any time by updating
          this post. Use of the App after such changes are posted will signify
          your acceptance of these revised terms. You should visit this page
      ...
      <section>
        ...
        <p>
          ...
          experiencing one. TEMA does not provide emergency medical services or
          immediate assistance for life-threatening conditions.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Using TEMA does not create a physical doctor-patient relationship
          between you and any healthcare provider you interact with through the
          platform. Consultations provided via TEMA are virtual and should not
      ...
      <section>
        ...
        <p>
          TEMA is provided on an "as is" and "as available" basis. We do not
          warrant the platform being uninterrupted, error-free, or free from
          viruses or other harmful components. To the fullest extent permitted
          by law, TEMA disclaims all warranties, express or implied, including
      ...
      <section>
        ...
        <p>
          ...
          arising out of or relating to your use of the platform is limited to
      ...
      <section>
        ...
        <p>
          ...
          images, and software, is the property of TEMA or its content suppliers
          and is protected by copyright laws. Unauthorized use of any content on
      ...
      <section>
        <h2>Linking</h2>
        <p>
          You may link to our platform, provided you do so in a way that is fair
      ...
      <section>
        ...
        <p>
          All intellectual property rights in the platform and its content are
          owned by TEMA or its licensors. You are not granted any rights in or
          to the platform or its content, except for the limited license to use
      ...
      <section>
        ...
        <p>
          The software that operates the TEMA platform is licensed, not sold, to
          you. TEMA retains all ownership rights to the software. You may not
      ...
      <section>
        ...
        <p>
          You must not use the platform in any way that causes, or is likely to
          cause, the platform or access to it to be interrupted, damaged, or
          impaired in any way. You must not use the platform for any fraudulent
          or unlawful purpose.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          believe your account has been compromised, you must notify us
          immediately.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          personal and medical information. However, no method of transmission
          ...
          security. Please refer to our Privacy Policy for more details on how
          we handle your data.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          Use of the platform is prohibited in any jurisdiction where such use
          would violate any law or regulation. You are responsible for
      ...
      <section>
        ...
        <p>
          ...
          with the laws of Nigeria and Ghana. Any disputes arising from these
      ...
      <section>
        <h2>Termination</h2>
        <p>
          TEMA reserves the right to terminate or suspend your account at any
          time, without notice, for any reason, including but not limited to,
          violation of these Terms and Conditions. Upon termination, your right
          to use the platform will immediately cease. You may terminate your
      ...
      <section>
        ...
        <p>
          ...
          other legal notices published by TEMA on the platform, constitute the
          entire agreement between you and TEMA concerning the platform. Any
          prior agreements or understandings, whether written or oral, are
